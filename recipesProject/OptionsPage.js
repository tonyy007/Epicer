...
export default function App() {
    return (
      <View style={styles.container}>
          <ImageBackground source = {require('./assets/FoodCamImage.jpg')} style = {styles.image1}>
          <View style = {styles.transparant}>
            <Text style = {[styles.textStyle , {backgroundColor: 'transparent'}]}>Use camera to scan</Text>
          </View>
          </ImageBackground>

          <ImageBackground source = {require('./assets/FoodTypingImage.jpg')} style = {styles.image2}>
          <View style = {styles.transparant}>
